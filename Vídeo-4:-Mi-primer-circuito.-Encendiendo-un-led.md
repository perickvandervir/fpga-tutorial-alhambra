...
Los circuitos digitales trabajan con **BITs**, que son **elementos de información** que pueden estar en dos estados: **uno** o **cero**. Estos dos estados pueden representar difernetes cosas, como por ejemplo *encendido* - *apago*, *verdadero* o *falso*, *arriba* o *abajo*, *5 voltios* - *0 voltios*, el *ying* o el *yang*, *culo* o *codo* :-)
